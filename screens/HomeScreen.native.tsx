...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      <MapView
        key={`${coords.latitude}-${coords.longitude}-${selectedDestination?.id ?? 'none'}`}
        ...
        {selectedDestination ? <Marker coordinate={selectedDestination.coords} title={selectedDestination.label} /> : null}
        {selectedDestination ? (
          <Polyline coordinates={[coords, selectedDestination.coords]} strokeWidth={5} strokeColor={AppTheme.colors.primary} />
        ) : null}
      </MapView>
